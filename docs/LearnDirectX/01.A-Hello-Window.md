...
**style** specifies some additional information about the window. **CS_HREDRAW&nbsp;&VerticalLine;&nbsp;CS_VREDRAW** indicates to redraw the entire window if a size adjustment changes the width and\or height of the client area.
