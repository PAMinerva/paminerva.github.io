...
$$\begin{equation}\tag{1}\label{eq:1}\mathbf{v}\cdot\mathbf{u}=\|\mathbf{v}\|\ \|\mathbf{u}\|\cos{\theta}\end{equation}$$
...
From the equation $\ref{1}$ we can derive other properties. For example,
