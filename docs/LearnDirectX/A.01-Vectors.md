...
>
>$\big({\color{orange}{a_y (b_xc_y-b_yc_x)-a_z (b_zc_x-b_xc_z)}},\ {\color{limegreen}{a_z (b_yc_z-b_zc_y)-a_x\ (b_xc_y-b_yc_x)}},\ {\color{cyan}{a_x (b_zc_x-b_xc_z)-a_y(b_yc_z-b_zc_y)}}\big)$
>
><br>
>
...
>
>${\color{orange}{a_y (b_xc_y-b_yc_x)-a_z (b_zc_x-b_xc_z)}}$
>
><br>
>
