...
$$\begin{equation}\label{eq:1}\mathbf{v}\cdot\mathbf{u}=\|\mathbf{v}\|\ \|\mathbf{u}\|\cos{\theta}\end{equation}$$
...
From the equation $\eqref{eq:1}$ we can derive other properties. For example,
