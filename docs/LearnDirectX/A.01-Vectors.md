...
$\big(\color{\#FF6666}{a_y (b_xc_y-b_yc_x)-a_z (b_zc_x-b_xc_z)},\ \color{\#44FFAA}{a_z (b_yc_z-b_zc_y)-a_x\ (b_xc_y-b_yc_x)},\ \color{\#44AAFF}{a_x (b_zc_x-b_xc_z)-a_y(b_yc_z-b_zc_y)}\color{}{\big)}$
