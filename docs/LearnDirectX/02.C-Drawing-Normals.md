...
When multiple stream output objects exist, the number of scalars is computed from the largest structure defining the type of the emitted vertices.
...
>***Proof***
>
>Building a similar triangle along $AC$, you can get a diagram below
>
><br>
>
...
>
>The same applies to the other two medians by building similar triangles along the other sides of the triangle.
>
>$\Box$
>
><br>
